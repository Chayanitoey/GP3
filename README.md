...
The prompt assigned for GPT-3 is **'What is the product that the following reviews talk about?'**, from the review input, GP3 will generate topic or product that is most relevant and best respresentation of that cluster. 
